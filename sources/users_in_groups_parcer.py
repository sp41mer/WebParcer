    ...
    for group in Group.select().limit(1):
        ...
        for info in q[0].members:
            ...
            try:
                ...
                if info[0].get('country'):
                    a.country_id = info[0].get('country').get('id')
                    a.country_title = info[0].get('country').get('title')
                if info[0].get('city'):
                    a.city_id = info[0].get('city').get('id')
                    a.city_title = info[0].get('city').get('title')
